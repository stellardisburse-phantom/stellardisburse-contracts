# Contributing to StellarDisburse

Thank you for your interest in contributing to StellarDisburse — Open Extension Infrastructure for the Stellar Disbursement Platform (SDP). This guide covers everything you need to get started.
...
StellarDisburse participates in the **Stellar Drips Wave** program. Funded issues are tagged with the `Stellar Wave` label on GitHub and detailed in the project's issue list.
...
git clone https://github.com/stellardisburse-phantom/stellardisburse-sdk
cd stellardisburse-sdk
...
Thank you for contributing to StellarDisburse! 🚀
